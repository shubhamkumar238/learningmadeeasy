...
insert into learning_made_easy.course_student values(1, 1, "cat1");
insert into learning_made_easy.course_student values(1, 2,"cat1");
insert into learning_made_easy.course_student values(1, 3, "cat1");
insert into learning_made_easy.course_student values(3, 2, "cat1");
insert into learning_made_easy.course_student values(4, 2, "cat1");
insert into learning_made_easy.course_student values(6, 2, "cat1");
